...
x = file.readline()
if int(x) == 0:
    response = wget.download("https://github.com/Ahmedtronic/FindSimilar/raw/main/metadata-files/vgg19/image_data_features.pkl")
    response2 = wget.download("https://github.com/Ahmedtronic/FindSimilar/raw/main/metadata-files/vgg19/image_features_vectors.idx")
